...
run_outer_cv "XGBOOST" "OvR" "CV" "inner_cv_best_params/XGBOOST/XGBOOST_best_param_OvR.csv"
...
run_outer_cv "XGBOOST" "OvR" "loso" "inner_cv_best_params/XGBOOST/XGBOOST_best_param_OvR_loso.csv"
...
run_outer_cv "SVM" "OvR" "CV" "inner_cv_best_params/SVM/SVM_best_param_OvR.csv"
...
run_outer_cv "SVM" "OvR" "loso" "inner_cv_best_params/SVM/SVM_best_param_OvR_loso.csv"
