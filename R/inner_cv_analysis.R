...
main_inner_cv <- function(){
  ...
  evaluate_single_matrix_with_rejection <- function(prob_matrix, fold_name, model_name, type) {
    ...
    prob_cutoffs <- seq(0.00, 1.00, by = 0.005)
  ...
  cv_cutoffs <- rejection_results[["cv"]][["optimal_results"]][["optimal_cutoffs"]]
  loso_cutoffs <- rejection_results[["loso"]][["optimal_results"]][["optimal_cutoffs"]]
  ...
  write.csv(combined_cutoffs, "../data/out/inner_cv/cutoffs/cutoffs.csv")
  ...
  print(inner_cv_results[["rejection_results"]][["cv"]][["optimal_results"]][["summary_stats"]])
  print(inner_cv_results[["rejection_results"]][["loso"]][["optimal_results"]][["summary_stats"]])
