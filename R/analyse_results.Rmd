...
```{r}
outer_unmerged <-  readRDS("../data/out/outer_cv/outer_cv_results_28jan2025_unmerged_maxprob.rds")
outer_merged <- readRDS("../data/out/outer_cv/outer_cv_results_28jan2025_merged_maxprob.rds")
```
...
per_class <- apply(per_class, 2, function(x) round(x, 2))
  ...
  total_conf_norm <- apply(total_conf, 1, normalise)
