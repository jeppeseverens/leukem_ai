...
```{r}
readRDS("../data/out/inner_cv/inner_cv_results_10feb2026_merged_summed.rds")$final_results
```


```{r}
#source("outer_cv_analysis.R")
#outer_cv_results_unmerged[["performance_comparison"]][["cv"]][,c("Model","Original_Kappa",  "Rejection_Kappa", "Mean_Percent_Rejected")]
#outer_cv_results_merged[["performance_comparison"]][["cv"]][,c("Model", "Original_Kappa", "Rejection_Kappa", "Mean_Percent_Rejected")]
```
```{r}
#readRDS("../data/out/outer_cv/outer_cv_results_10feb26_unmerged_maxprob.rds")[["performance_comparison"]][["cv"]][,c("Model", "Original_Kappa", "Rejection_Kappa", "Mean_Percent_Rejected")]
#readRDS("../data/out/outer_cv/outer_cv_results_10feb26_merged_summed.rds")[["performance_comparison"]][["cv"]][,c("Model", "Original_Kappa", "Rejection_Kappa", "Mean_Percent_Rejected")]
```

```{r}
outer_unmerged <-  readRDS("../data/out/outer_cv/outer_cv_results_10feb26_2_unmerged_maxprob.rds")
outer_merged <- readRDS("../data/out/outer_cv/outer_cv_results_10feb26_2_merged_summed.rds")
```
...
py_run_string("pipeline = joblib.load('../data/out/final_models/pipelines/pipeline_ngenes_5000.pkl')")
...
files <- list.files("../data/STAR_AML_MLLlab_predictions", full.names = T)
...
```{r}
cutoff <- read.csv("../data/out/final_train_test/cutoffs_merged_summed/train_test_cutoffs_merged_summed.csv")
...
perc_rej <- 100 - sum(MLL_lab_predictions_passes & MLL_lab_truth != "AML..NOS") / length(MLL_lab_predictions_passes[MLL_lab_truth != "AML..NOS"]) * 100 
round(perc_rej, 3)
